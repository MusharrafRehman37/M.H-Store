                ...
                <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full sm:w-72 bg-gray-900 border border-gray-700 rounded-xl py-3.5 pl-11 pr-4 text-sm text-white outline-none focus:border-blue-500 transition"
                    />
                  </div>

                  <button
                    type="submit"
                    className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 px-6 py-3.5 rounded-xl font-semibold transition"
                  >
                    Subscribe
                    <ArrowRight size={17} />
                  </button>
